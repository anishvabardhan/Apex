...
int main()
{
	...
	float p_Angle = 0.0f, o_Angle = 0.0f, p_X = 0.0f, p_Y = 0.0f, o_X = 0.0f, o_Y = 0.0f, a_X = 0.0f, a_Y = 0.0f;
	...
	{   
		...
		while (g_App.IsRun())
		{
			...
			if ((g_Player.GetPosition().m_X + p_X + 12.0f >= g_Object.GetPostion().m_X + p_X && g_Player.GetPosition().m_X + p_X <= g_Object.GetPostion().m_X + o_X + 52.0f) && (g_Player.GetPosition().m_Y + p_Y + 12.0f >= g_Object.GetPostion().m_Y + o_Y && g_Player.GetPosition().m_Y + p_Y <= g_Object.GetPostion().m_Y + o_Y + 52.0f))
			{
				break;
			}
